...
const int kDefaultMaxMem = 8 << 20;

// Interface for regular expression matching.  Also corresponds to a
// pre-compiled regular expression.  An "RE2" object is safe for
// concurrent use by multiple threads.
class __declspec(dllexport) RE2 {
 public:
...
#endif
  __thiscall RE2(const StringPiece& pattern);
  __thiscall RE2(const StringPiece& pattern, const Options& options);
  __thiscall ~RE2();
...
class __declspec(dllexport) RE2::Arg {
 public:
